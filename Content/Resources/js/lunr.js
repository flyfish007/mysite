...
lunr.tokenizer = function (obj) {
  ...
  if(typeof nodejieba_segment !== "undefined"){
      nodejieba_segment.load({
      dict: nodejieba_segment.DEFAULT_DICT,
      hmmDict: nodejieba_segment.DEFAULT_HMM_DICT,
      userDict: 'userdict.utf8',
      idfDict: nodejieba_segment.DEFAULT_IDF_DICT,
      stopWordDict: nodejieba_segment.DEFAULT_STOP_WORD_DICT,
    });

    return nodejieba_segment.cutForSearch(str, true);
  }else{
    return str
